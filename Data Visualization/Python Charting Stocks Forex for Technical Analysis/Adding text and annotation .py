# -*- coding: utf-8 -*-
"""
Created on Fri Jul 26 10:43:17 2019
...
def graphData(df, MA1, MA2):
    try:
       ...
       # ax1 = plt.axes(axisbg='#07000d')
        ...
        ax1.annotate('Big News', (time[555], Av1[555]), xytext=(0.8,0.8),
                     textcoords='axes fraction', 
                     arrowprops=dict(facecolor='white', shrink=0.05),
                     fontsize='14',
                     color='w')
                    # horizaontalaligment='right',
       ...
       # ax2 = plt.axes(axisbg='#07000d')
        ...
        plt.suptitle('AAPL Stock Price', fontsize=20 , fontweight='bold', color='w')
