# -*- coding: utf-8 -*-
"""
Created on Thu Jul 25 23:59:01 2019

@author: sxw17
"""

# 12. Customizing Matplotlib Chart 
...
df.to_csv('TSLA_years.csv')

tsla_df= pd.read_csv('TSLA_years.csv')
...
def graphData(df):
    try:
       ...
       # ax1 = plt.axes(axisbg='#07000d')
        ...
        mpf.candlestick_ohlc(ax1,ohlc,width=0.4,colorup='#9eff15',colordown='#ff1717')
       ...
       # ax2 = plt.axes(axisbg='#07000d')
        ...
        plt.suptitle('TSLA Stock Price', fontsize='large', fontweight='bold', color='w')
