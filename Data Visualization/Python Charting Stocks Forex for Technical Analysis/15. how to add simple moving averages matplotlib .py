# -*- coding: utf-8 -*-
"""
Created on Fri Jul 26 01:04:05 2019

@author: sxw17
"""

# 15. how to add simple moving averages matplotlib 
import os 
os.getcwd()
...
eachStock=['AAPL','GOOG','MSFT','CMG','AMZN','EBAY','TSLA']
...
while True:
    for stock in eachStock:
        ...
        #df.to_csv('EBAY_ONE_YEAR.csv')
        #ebay_df= pd.read_csv('EBAY_THREE_YEAR.csv')
